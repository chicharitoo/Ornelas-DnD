// ══════════════════════════════════════════════════════════════
    ...
    <div class="panel-inner" style="background:${d.bg}55;border-color:${d.color}33">
      <div class="panel-header">
        <div>
          <div class="panel-title" style="color:${d.textColor}">${d.icon} ${d.label} Cards</div>
    ...
    function renderForge() {
      ...
      <div class="campaign-picker">
        ${CAMPAIGNS.map(c => `<button class="camp-btn ${c.id === selectedCamp ? 'active' : ''}" onclick="setCamp('${c.id}')">
    ...
    function render() {
      ...
      }).join('') + `<button class="tab-btn ${activeTab === 'forge' ? 'active' : ''}" style="${activeTab === 'forge' ? 'background:rgba(200,160,32,0.12);border-color:rgba(200,160,32,0.5);color:#e8c040' : ''}" onclick="switchTab('forge')">⚔ Adventure Forge</button>`;
